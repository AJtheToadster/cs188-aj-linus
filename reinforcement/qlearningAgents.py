...
class QLearningAgent(ReinforcementAgent):
    ...
    def computeValueFromQValues(self, state):
        ...
        for action in legalActions:
            ...
            if curr > maxValue:
                maxValue = curr
            if curr == maxValue:
                maxValue = random.choice([maxValue, curr])
        return maxValue
    ...
    def computeActionFromQValues(self, state):
        ...
        for action in legalActions:
            ...
            if curr > maxValue:
                ...
                maxValue = curr
            if curr == maxValue:
                bestAction, maxValue = random.choice([(bestAction, maxValue), (action, curr)])
    ...
    def update(self, state, action, nextState, reward):
        ...
        self.qValues[(state, action)] = (1 - self.alpha) * oldQ + self.alpha * newSample
...
class ApproximateQAgent(PacmanQAgent):
    ...
    def update(self, state, action, nextState, reward):
        ...
        for i in range(len(self.weights)):
            self.weights[i] = self.weights[i] + self.alpha * diff * feats[(state, action)]
